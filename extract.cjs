const fs = require('fs');
const lines = fs.readFileSync('ent_temp.txt', 'utf8').split('\n');

const matrixDataLogic = lines.slice(826, 930).join('\n'); // ── Matrix Table Data
...
fs.writeFileSync('src/pages/ent-results/tabs/EntMatrixTab.tsx', code);
console.log('Success');
