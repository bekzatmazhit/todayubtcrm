...
export async function fetchHealth() {
  const res = await fetch(`${API_BASE}/health`, defaultOptions);
...
export async function fetchUsers() {
  try {
    const res = await fetch(`${API_BASE}/users`, defaultOptions);
...
export async function fetchUser(id: string) {
  try {
    const res = await fetch(`${API_BASE}/users/${id}`, defaultOptions);
...
export async function createUser(data: Record<string, unknown>) {
  const res = await fetch(`${API_BASE}/users`, { ...defaultOptions, method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(data) });
  if (!res.ok) throw new Error(await res.text());
  return res.json();
}

export async function updateUser(id: number, data: Record<string, unknown>) {
  const res = await fetch(`${API_BASE}/users/${id}`, { ...defaultOptions, method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(data) });
  if (!res.ok) throw new Error(await res.text());
  return res.json();
}

export async function deleteUser(id: number) {
  const res = await fetch(`${API_BASE}/users/${id}`, { ...defaultOptions, method: "DELETE" });
  if (!res.ok) throw new Error(await res.text());
  return res.json();
}
...
export async function uploadAvatar(userId: string | number, file: File) {
  const fd = new FormData();
  fd.append("avatar", file);
  const res = await fetch(`${API_BASE}/users/${userId}/avatar`, { ...defaultOptions, method: "POST", body: fd });
  if (!res.ok) throw new Error(await res.text());
  return res.json();
}

export async function deleteAvatar(userId: string | number) {
  const res = await fetch(`${API_BASE}/users/${userId}/avatar`, { ...defaultOptions, method: "DELETE" });
  if (!res.ok) throw new Error(await res.text());
  return res.json();
}

export async function updateStudent(id: number, data: Record<string, unknown>) {
  const res = await fetch(`${API_BASE}/students/${id}`, { ...defaultOptions, method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(data) });
  if (!res.ok) throw new Error(await res.text());
  return res.json();
}
...
export async function createGroup(data: Record<string, unknown>) {
  const res = await fetch(`${API_BASE}/groups`, { ...defaultOptions, method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(data) });
  if (!res.ok) throw new Error(await res.text());
  return res.json();
}

export async function updateGroup(id: number, data: Record<string, unknown>) {
  const res = await fetch(`${API_BASE}/groups/${id}`, { ...defaultOptions, method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(data) });
  if (!res.ok) throw new Error(await res.text());
  return res.json();
}

export async function deleteGroup(id: number) {
  const res = await fetch(`${API_BASE}/groups/${id}`, { ...defaultOptions, method: "DELETE" });
  if (!res.ok) throw new Error(await res.text());
  return res.json();
}
...
export async function fetchSubjects() {
  try {
    const res = await fetch(`${API_BASE}/subjects`, defaultOptions);
    if (!res.ok) throw new Error("Failed");
    return await res.json();
  } catch { return []; }
}
...
export async function createSubject(data: Record<string, unknown>) {
  const res = await fetch(`${API_BASE}/subjects`, { ...defaultOptions, method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(data) });
  if (!res.ok) throw new Error(await res.text());
  return res.json();
}

export async function updateSubject(id: number, data: Record<string, unknown>) {
  const res = await fetch(`${API_BASE}/subjects/${id}`, { ...defaultOptions, method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(data) });
  if (!res.ok) throw new Error(await res.text());
  return res.json();
}

export async function deleteSubject(id: number) {
  const res = await fetch(`${API_BASE}/subjects/${id}`, { ...defaultOptions, method: "DELETE" });
  if (!res.ok) throw new Error(await res.text());
  return res.json();
}
...
export async function fetchProfiles() {
  try {
    const res = await fetch(`${API_BASE}/profiles`, defaultOptions);
    if (!res.ok) throw new Error("Failed");
    return await res.json();
  } catch { return []; }
}
...
export async function fetchAdhocLessons(date?: string, teacherId?: string) {
  try {
    ...
    const res = await fetch(`${API_BASE}/adhoc-lessons?${params}`, defaultOptions);
...
export async function createAdhocLesson(data: {
  ...
  const res = await fetch(`${API_BASE}/adhoc-lessons`, { ...defaultOptions, method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(data) });
...
export async function updateAdhocLessonAttendance(id: number, students: { student_id: number; status: string; lateness: string; homework: string; comment?: string }[]) {
  const res = await fetch(`${API_BASE}/adhoc-lessons/${id}/attendance`, { ...defaultOptions, method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ students }) });
  if (!res.ok) throw new Error("Failed to update adhoc attendance");
  return await res.json();
}

export async function deleteAdhocLesson(id: number) {
  const res = await fetch(`${API_BASE}/adhoc-lessons/${id}`, { ...defaultOptions, method: "DELETE" });
...
export async function deleteStudent(id: number) {
  try {
    const res = await fetch(`${API_BASE}/students/${id}`, { ...defaultOptions, method: "DELETE" });
...
export async function deleteScheduleEntry(id: number) {
  const res = await fetch(`${API_BASE}/schedule/${id}`, { ...defaultOptions, method: "DELETE" });
...
export async function moveScheduleEntry(id: number, data: { teacher_id: number; time_slot_id: number; cycle: string }) {
  const res = await fetch(`${API_BASE}/schedule/${id}/move`, {
    ...defaultOptions,
    method: "PATCH",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(data),
...
export async function checkScheduleConflicts(data: {
  ...
  try {
    const res = await fetch(`${API_BASE}/schedule/check-conflicts`, {
      ...defaultOptions,
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(data),
...
export async function fetchRooms() {
  try {
    const res = await fetch(`${API_BASE}/rooms`, defaultOptions);
...
export async function fetchTimeSlots() {
  try {
    const res = await fetch(`${API_BASE}/time-slots`, defaultOptions);
...
export async function saveEntResult(data: { student_id: number; subject_id: number; score: number; month: string }) {
  try {
    const res = await fetch(`${API_BASE}/ent-results`, {
      ...defaultOptions,
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(data),
...
export async function saveEntResultsBatch(scores: { student_id: number; subject_id: number; score: number; month: string }[]) {
  try {
    const res = await fetch(`${API_BASE}/ent-results/batch`, {
      ...defaultOptions,
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
export async function fetchTasks() {
  try {
    const res = await fetch(`${API_BASE}/tasks`, defaultOptions);
...
export async function toggleChecklistItem(id: number, is_completed: number) {
  try {
    const res = await fetch(`${API_BASE}/tasks/checklist/${id}`, {
      ...defaultOptions,
      method: "PUT",
      headers: { "Content-Type": "application/json" },
...
export async function deleteChecklistItem(id: number) {
  try {
    const res = await fetch(`${API_BASE}/tasks/checklist/${id}`, { method: "DELETE" });
    if (!res.ok) throw new Error("Failed");
    return await res.json();
  } catch { return null; }
}
...
export async function processRecurringTasks() {
  try {
    const res = await fetch(`${API_BASE}/tasks/process-recurring`, { method: "POST" });
    if (!res.ok) throw new Error("Failed");
    return await res.json();
  } catch { return null; }
}
...
export async function fetchCuratorGroups(curatorId: number) {
  try {
    const res = await fetch(`${API_BASE}/curatorship/my-groups?curator_id=${curatorId}`);
    if (!res.ok) throw new Error("Failed");
    return await res.json();
  } catch { return []; }
}
...
export async function fetchCuratorStudents(curatorId: number) {
  try {
    const res = await fetch(`${API_BASE}/curatorship/my-students?curator_id=${curatorId}`);
    if (!res.ok) throw new Error("Failed");
    return await res.json();
  } catch { return []; }
}
...
export async function fetchCuratorMetrics(curatorId: number) {
  try {
    const res = await fetch(`${API_BASE}/curatorship/metrics?curator_id=${curatorId}`);
    if (!res.ok) throw new Error("Failed");
    return await res.json();
  } catch { return null; }
}
...
export async function fetchStudentDetails(studentId: number) {
  try {
    const res = await fetch(`${API_BASE}/curatorship/student/${studentId}/details`);
    if (!res.ok) throw new Error("Failed");
    return await res.json();
...
export async function fetchStudentMonthlyStats(studentId: number, from: string, to: string) {
  try {
    const res = await fetch(`${API_BASE}/curatorship/student/${studentId}/monthly-stats?from=${encodeURIComponent(from)}&to=${encodeURIComponent(to)}`);
    if (!res.ok) throw new Error("Failed");
    return await res.json();
...
export async function fetchAttendanceGrid(groupId: number, from: string, to: string) {
  try {
    const res = await fetch(`${API_BASE}/curatorship/attendance-grid?group_id=${groupId}&from=${encodeURIComponent(from)}&to=${encodeURIComponent(to)}`);
    if (!res.ok) throw new Error("Failed");
    return await res.json();
...
export async function fetchParentFeedback(params: { curator_id?: number; student_id?: number } = {}) {
  try {
    ...
    const res = await fetch(`${API_BASE}/parent-feedback?${q}`);
    if (!res.ok) throw new Error("Failed");
    return await res.json();
  } catch { return []; }
}
...
export async function updateParentFeedback(id: number, data: Record<string, unknown>) {
  try {
    const res = await fetch(`${API_BASE}/parent-feedback/${id}`, {
      method: "PUT",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(data),
    });
...
export async function deleteParentFeedback(id: number) {
  try {
    const res = await fetch(`${API_BASE}/parent-feedback/${id}`, { method: "DELETE" });
    if (!res.ok) throw new Error("Failed");
    return await res.json();
  } catch { return null; }
}
...
export async function generateCallTasks(curatorId: number) {
  try {
    const res = await fetch(`${API_BASE}/curatorship/call-tasks/generate`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
export async function fetchCallTasks(curatorId: number, month?: string) {
  try {
    ...
    const res = await fetch(`${API_BASE}/curatorship/call-tasks?${q}`);
    if (!res.ok) throw new Error("Failed");
    return await res.json();
...
export async function updateCallTask(id: number, data: { status?: string; call_result?: string; notes?: string }) {
  try {
    const res = await fetch(`${API_BASE}/curatorship/call-tasks/${id}`, {
      method: "PATCH",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(data),
    });
...
export async function fetchCallTasksSummary(month?: string) {
  try {
    ...
    const res = await fetch(`${API_BASE}/curatorship/call-tasks/summary${q}`);
    if (!res.ok) throw new Error("Failed");
    return await res.json();
...
export async function generateTeacherFeedback(teacherId: number) {
  try {
    const res = await fetch(`${API_BASE}/teacher-feedback/generate`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
export async function fetchTeacherFeedback(teacherId: number, month?: string) {
  try {
    ...
    if (month) q.append("month", month);
    const res = await fetch(`${API_BASE}/teacher-feedback?${q}`);
    if (!res.ok) throw new Error("Failed");
    return await res.json();
  } catch { return { tasks: [], total: 0, completed: 0, month: "" }; }
}
...
export async function updateTeacherFeedback(id: number, comment: string) {
  try {
    const res = await fetch(`${API_BASE}/teacher-feedback/${id}`, {
      method: "PATCH",
      headers: { "Content-Type": "application/json" },
...
export async function fetchTeacherFeedbackByStudent(studentId: number, month?: string) {
  try {
    ...
    if (month) q.append("month", month);
    const res = await fetch(`${API_BASE}/teacher-feedback/by-student?${q}`);
    if (!res.ok) throw new Error("Failed");
    return await res.json();
  } catch { return []; }
}
...
export async function fetchTeacherFeedbackSummary(month?: string) {
  try {
    const q = month ? `?month=${encodeURIComponent(month)}` : "";
    const res = await fetch(`${API_BASE}/teacher-feedback/summary${q}`);
    if (!res.ok) throw new Error("Failed");
    return await res.json();
  } catch { return { summary: [], month: "" }; }
}
...
export async function uploadTaskAttachment(taskId: number, file: File) {
  try {
    ...
    const res = await fetch(`${API_BASE}/tasks/${taskId}/attachments`, { method: "POST", body: form });
    if (!res.ok) throw new Error("Failed");
    return await res.json();
  } catch { return null; }
}
...
export async function deleteTaskAttachment(attachmentId: number) {
  try {
    const res = await fetch(`${API_BASE}/tasks/attachments/${attachmentId}`, { method: "DELETE" });
    if (!res.ok) throw new Error("Failed");
    return await res.json();
  } catch { return null; }
}
...
export async function fetchMyNotifications(userId: number): Promise<AppNotification[]> {
  try {
    const res = await fetch(`${API_BASE}/notifications/my?user_id=${userId}`);
    if (!res.ok) throw new Error("Failed");
    return await res.json();
  } catch { return []; }
}
...
export async function updateWikiCategory(id: number, data: { name?: string; order_index?: number }) {
  const res = await fetch(`${API_BASE}/wiki/categories/${id}`, {
...
export async function deleteWikiCategory(id: number) {
  const res = await fetch(`${API_BASE}/wiki/categories/${id}`, { method: "DELETE" });
  if (!res.ok) throw new Error("Failed");
  return res.json();
}
...
export async function fetchWikiArticle(id: number) {
  const res = await fetch(`${API_BASE}/wiki/articles/${id}`);
  if (!res.ok) throw new Error("Failed");
  return res.json();
}
...
export async function deleteWikiArticle(id: number) {
  const res = await fetch(`${API_BASE}/wiki/articles/${id}`, { method: "DELETE" });
  if (!res.ok) throw new Error("Failed");
  return res.json();
}
...
export async function fetchStorageFolders(parentId?: number | null) {
  try {
    ...
    const res = await fetch(`${API_BASE}/storage/folders?parent_id=${param}`);
    if (!res.ok) throw new Error("Failed");
...
export async function createStorageFolder(data: { name: string; parent_id?: number | null; creator_id?: number | null }) {
  const res = await fetch(`${API_BASE}/storage/folders`, {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(data),
  });
...
export async function deleteStorageFolder(id: number) {
  const res = await fetch(`${API_BASE}/storage/folders/${id}`, { method: "DELETE" });
  if (!res.ok) throw new Error(await res.text());
  return await res.json();
}

export async function updateStorageFolder(id: number, data: { name?: string; icon?: string | null }) {
  const res = await fetch(`${API_BASE}/storage/folders/${id}`, {
    method: "PATCH",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(data),
  });
...
export async function fetchStorageItems(folderId?: number | null) {
  try {
    ...
    const res = await fetch(`${API_BASE}/storage/items?folder_id=${param}`);
    if (!res.ok) throw new Error("Failed");
...
export async function createStorageLink(data: { folder_id?: number | null; name: string; url_or_path: string; uploaded_by?: number | null }) {
  const res = await fetch(`${API_BASE}/storage/items/link`, {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(data),
  });
...
export async function uploadStorageFile(folderId: number | null, file: File, userId: number | null) {
  ...
  const res = await fetch(`${API_BASE}/storage/items/file`, { method: "POST", body: form });
  if (!res.ok) throw new Error(await res.text());
  return await res.json();
}

export async function deleteStorageItem(id: number) {
  const res = await fetch(`${API_BASE}/storage/items/${id}`, { method: "DELETE" });
  if (!res.ok) throw new Error(await res.text());
  return await res.json();
}

export async function updateStorageItem(id: number, data: { name?: string; icon?: string | null }) {
  const res = await fetch(`${API_BASE}/storage/items/${id}`, {
    method: "PATCH",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(data),
  });
...
export async function createDynamicTable(data: { creator_id: number; title: string; columns_json: unknown[]; visibility: string }) {
  const res = await fetch(`${API_BASE}/dynamic-tables`, {
    method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(data),
  });
...
export async function updateDynamicTable(id: number, data: { title?: string; columns_json?: unknown[]; visibility?: string }) {
  const res = await fetch(`${API_BASE}/dynamic-tables/${id}`, {
    method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(data),
  });
...
export async function deleteDynamicTable(id: number) {
  const res = await fetch(`${API_BASE}/dynamic-tables/${id}`, { method: "DELETE" });
  if (!res.ok) throw new Error("Failed to delete table");
  return res.json();
}

export async function fetchDynamicTableRows(tableId: number) {
  const res = await fetch(`${API_BASE}/dynamic-tables/${tableId}/rows`);
...
export async function updateDynamicTableRow(rowId: number, rowData: Record<string, unknown>) {
  const res = await fetch(`${API_BASE}/dynamic-table-rows/${rowId}`, {
...
export async function deleteDynamicTableRow(rowId: number) {
  const res = await fetch(`${API_BASE}/dynamic-table-rows/${rowId}`, { method: "DELETE" });
  if (!res.ok) throw new Error("Failed to delete row");
  return res.json();
}

export async function importGoogleSheet(url: string): Promise<{ sheets?: { gid: string; name: string; headers: string[]; rows: string[][] }[]; headers?: string[]; rows?: string[][] }> {
  const res = await fetch(`${API_BASE}/import-google-sheet`, {
...
export async function fetchBroadcasts(userId: number) {
  const res = await fetch(`${API_BASE}/broadcasts?user_id=${userId}`);
  if (!res.ok) throw new Error("Failed to fetch broadcasts");
  return res.json();
}

export async function fetchUnreadBroadcastCount(userId: number) {
  const res = await fetch(`${API_BASE}/broadcasts/unread-count?user_id=${userId}`);
...
export async function markBroadcastRead(messageId: number, userId: number) {
  const res = await fetch(`${API_BASE}/broadcasts/${messageId}/read`, {
...
export async function deleteBroadcast(messageId: number) {
  const res = await fetch(`${API_BASE}/broadcasts/${messageId}`, { method: "DELETE" });
...
export async function fetchAttendanceStats(months = 6) {
  const res = await fetch(`${API_BASE}/dashboard/attendance-stats?months=${months}`);
...
export async function fetchTeacherAnalytics(teacherId: string | number, months = 6) {
  const res = await fetch(`${API_BASE}/analytics/teacher/${teacherId}?months=${months}`);
...
export async function fetchAttendanceReport(month: string, groupId?: number, teacherId?: number) {
  const params = new URLSearchParams({ month });
  if (groupId) params.set("group_id", String(groupId));
  if (teacherId) params.set("teacher_id", String(teacherId));
  const res = await fetch(`${API_BASE}/reports/attendance?${params}`);
  if (!res.ok) throw new Error("Failed to fetch attendance report");
  return res.json();
}

export async function fetchEntReport(groupId?: number, fromMonth?: string, toMonth?: string) {
  const params = new URLSearchParams();
  if (groupId) params.set("group_id", String(groupId));
  if (fromMonth) params.set("from_month", fromMonth);
  if (toMonth) params.set("to_month", toMonth);
  const res = await fetch(`${API_BASE}/reports/ent?${params}`);
  if (!res.ok) throw new Error("Failed to fetch ENT report");
  return res.json();
}
