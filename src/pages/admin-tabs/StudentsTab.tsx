...
type StudentForm = { full_name: string; phone: string; parent_phone: string; parent_name: string; group_id: number | null; status: "active" | "archive"; avatar_url: string; };
const emptyStudent = (): StudentForm => ({ full_name: "", phone: "", parent_phone: "", parent_name: "", group_id: null, status: "active", avatar_url: "" });

function StudentsTab({ toast, groups }
