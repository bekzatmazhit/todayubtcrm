...
type BannerForm = { title: string; subtitle: string; call_to_action: string; link_url: string; bg_color: string; text_color: string; icon_name: string; is_active: boolean; };
const emptyBanner = (): BannerForm => ({ title: "", subtitle: "", call_to_action: "", link_url: "", bg_color: "bg-indigo-600", text_color: "text-white", icon_name: "Megaphone", is_active: true });

function BannersTab({ toast, userId }
