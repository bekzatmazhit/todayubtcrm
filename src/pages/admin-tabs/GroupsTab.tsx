...
type GroupForm = { name: string; profile_id: number | null; curator_id: number | null; };
const emptyGroup = (): GroupForm => ({ name: "", profile_id: null, curator_id: null });

function GroupsTab({ toast, users, profiles }
